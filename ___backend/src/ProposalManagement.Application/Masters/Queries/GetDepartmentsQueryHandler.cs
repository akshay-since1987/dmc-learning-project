...
public class GetDepartmentsQueryHandler : IRequestHandler<GetDepartmentsQuery, PagedResult<MasterListItemDto>>
{
    private readonly IRepository<Department> _repo;

    public GetDepartmentsQueryHandler(IRepository<Department> repo)
    {
        _repo = repo;
    }

    public async Task<PagedResult<MasterListItemDto>> Handle(GetDepartmentsQuery request, CancellationToken cancellationToken)
    {
